...
void init_WebPage() {
  ...
  hexColorStr[8];
  sprintf(hexColorStr, "#%06X", Dynamic_leftColor);  // Format Dynamic_leftColor as a hex string
  sendData = "F_" + String(hexColorStr);
  webSocket.broadcastTXT(sendData);
  delay(10);

  hexColorStr[8];
  sprintf(hexColorStr, "#%06X", Dynamic_thrdColor);  // Format Dynamic_leftColor as a hex string
  sendData = "Z_" + String(hexColorStr);
  webSocket.broadcastTXT(sendData);
  delay(10);

  hexColorStr[8];
  sprintf(hexColorStr, "#%06X", Dynamic_RightColor);  // Format Dynamic_leftColor as a hex string
  sendData = "G_" + String(hexColorStr);
  webSocket.broadcastTXT(sendData);
  delay(10);

  hexColorStr[8];
  sprintf(hexColorStr, "#%06X", Dynamic_DRLColor);  // Format Dynamic_leftColor as a hex string
  sendData = "H_" + String(hexColorStr);
  webSocket.broadcastTXT(sendData);
  delay(10);

   hexColorStr[8];
  sprintf(hexColorStr, "#%06X", Dynamic_BrakeColor);  // Format Dynamic_leftColor as a hex string
...
void messageHandler(uint8_t num, uint8_t *payload, size_t length) {
  ...
  switch (payload[0]) {
    ...
    case 'a':
      ...
      break;
    case 'b':
      StartAnimation = getData.toInt();
      Serial.print("Received Start Animation type: ");
      Serial.println(getData);
      ...
      // Display a message in the serial monitor
      Serial.print("Start Animation type changed to: ");

      if (StartAnimation == 1) {
        Serial.println("BlinkStartON");
      } else if (StartAnimation == 2) {
        Serial.println("SequentialStartON");
      } else if (StartAnimation == 3) {
        Serial.println("StackStartON");
      } else if (StartAnimation == 4) {
        Serial.println("");
      } else {
        Serial.println("Unknown Animation Type");
      }
    ...
    case 'c':
      LeftDirection = getData.toInt();
      Serial.print("Received LeftDirection type: ");
      Serial.println(getData);
      ...
      case 'd':
      RightDirection = getData.toInt();
      Serial.print("Received RightDirection type: ");
      Serial.println(getData);
      ...
      // Display a message in the serial monitor
      Serial.print("RightDirection type changed to: ");
    ...
    case 'F':
      ...
      Dynamic_leftColor = ((Red << 16) & 0xFF0000) | ((Green << 8) & 0x00FF00) | (Blue & 0x0000FF);
    ...
    case 'Z':
      ...
      Dynamic_thrdColor = ((Red << 16) & 0xFF0000) | ((Green << 8) & 0x00FF00) | (Blue & 0x0000FF);

      col = converter.RGBToRGBW(Red, Green, Blue);
      thrdColor = leds_L->Color(col.r, col.g, col.b, col.w);
      Serial.println(getData);
      Serial.println(Dynamic_thrdColor);
      Serial.println(thrdColor);


      hexColorStr[8];
      sprintf(hexColorStr, "#%06X", Dynamic_thrdColor);  
    ...
    case 'G':
      ...
      Dynamic_RightColor = ((Red << 16) & 0xFF0000) | ((Green << 8) & 0x00FF00) | (Blue & 0x0000FF);
      ...
      hexColorStr[8];
      sprintf(hexColorStr, "#%06X", Dynamic_RightColor);  
    ...
    case 'H':
      ...
      Dynamic_DRLColor = ((Red << 16) & 0xFF0000) | ((Green << 8) & 0x00FF00) | (Blue & 0x0000FF);
      ...
      hexColorStr[8];
      sprintf(hexColorStr, "#%06X", Dynamic_DRLColor);  
    ...
    case 'I':
      ...
      Dynamic_BrakeColor = ((Red << 16) & 0xFF0000) | ((Green << 8) & 0x00FF00) | (Blue & 0x0000FF);
      ...
      hexColorStr[8];
      sprintf(hexColorStr, "#%06X", Dynamic_BrakeColor);  
